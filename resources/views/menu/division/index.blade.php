            ...
            <div class="px-4 py-3 border-top d-flex ">
                <ul class="list-inline mb-0">
                    <li class="list-inline-item me-0">
                        <i class= "bx bx-calendar me-0"></i> {{ \Carbon\Carbon::parse($division->created_at)->translatedFormat('d F Y') }}
                    </li>
                </ul>
                <div class="d-flex ms-auto gap-2">
                    <span>
                        <button data-bs-toggle="modal" class=" btn btn-sm btn-info btn-edit" data-id="${item.id}" id="${item.id}" data-name="${item.name}" style="">
